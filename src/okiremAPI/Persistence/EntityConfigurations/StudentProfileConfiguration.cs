...
public class StudentProfileConfiguration : IEntityTypeConfiguration<StudentProfile>
{
    public void Configure(EntityTypeBuilder<StudentProfile> builder)
    {
        ...
        builder.Property(sp => sp.FirstName).HasColumnName("FirstName").IsRequired();
        builder.Property(sp => sp.LastName).HasColumnName("LastName").IsRequired();
        builder.Property(sp => sp.ProfileImageUrl).HasColumnName("ProfileImageUrl");
        builder.Property(sp => sp.Email).HasColumnName("Email");
        builder.Property(sp => sp.AlternateEmail).HasColumnName("AlternateEmail");
        ...
        builder.Property(sp => sp.Gender).HasColumnName("Gender").IsRequired();
        ...
        builder.Property(sp => sp.SchoolNumber).HasColumnName("SchoolNumber");
        ...
        builder.Property(sp => sp.AverageScore).HasColumnName("AverageScore").IsRequired();
