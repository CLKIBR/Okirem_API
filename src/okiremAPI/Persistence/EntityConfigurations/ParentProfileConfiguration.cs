...
public class ParentProfileConfiguration : IEntityTypeConfiguration<ParentProfile>
{
    public void Configure(EntityTypeBuilder<ParentProfile> builder)
    {
        ...
        builder.Property(pp => pp.FirstName).HasColumnName("FirstName").IsRequired();
        builder.Property(pp => pp.LastName).HasColumnName("LastName").IsRequired();
        builder.Property(pp => pp.ProfileImageUrl).HasColumnName("ProfileImageUrl");
        builder.Property(pp => pp.Email).HasColumnName("Email");
        builder.Property(pp => pp.AlternateEmail).HasColumnName("AlternateEmail");
        ...
        builder.Property(pp => pp.Gender).HasColumnName("Gender").IsRequired();
