...
public class TeacherProfileConfiguration : IEntityTypeConfiguration<TeacherProfile>
{
    public void Configure(EntityTypeBuilder<TeacherProfile> builder)
    {
        ...
        builder.Property(tp => tp.FirstName).HasColumnName("FirstName").IsRequired();
        builder.Property(tp => tp.LastName).HasColumnName("LastName").IsRequired();
        builder.Property(tp => tp.ProfileImageUrl).HasColumnName("ProfileImageUrl");
        builder.Property(tp => tp.Email).HasColumnName("Email");
        builder.Property(tp => tp.AlternateEmail).HasColumnName("AlternateEmail");
        ...
        builder.Property(tp => tp.Gender).HasColumnName("Gender").IsRequired();
        ...
        builder.Property(tp => tp.Branch).HasColumnName("Branch");
